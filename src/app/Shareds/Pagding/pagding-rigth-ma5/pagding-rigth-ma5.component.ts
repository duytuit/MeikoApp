...
@Component({
  selector: 'app-pagding-rigth-ma5',
  inputs: [ 'itemCount', 'pageSize', 'pageIndex' ],
  outputs: [ 'pageIndexChange' ],
  templateUrl: './pagding-rigth-ma5.component.html',
  styleUrls: ['./pagding-rigth-ma5.component.css']
})
export class PagdingRigthMa5Component {
