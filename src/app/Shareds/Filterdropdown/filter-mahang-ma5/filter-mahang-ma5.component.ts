...
@Component({
  selector: 'app-filter-mahang-ma5',
  templateUrl: './filter-mahang-ma5.component.html',
  styleUrls: ['./filter-mahang-ma5.component.css']
})
export class FilterMahangMa5Component implements OnInit {
  @Input() dataSet: any;
